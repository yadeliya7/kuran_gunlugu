...
void showPrayerTimesBottomSheet(BuildContext context) {
  ...
  // Determine which title to show based on Ramadan status
  String getPrayerTimesTitle() {
    return isRamadan()
        ? t('prayer_times_title') // "İmsakiye - Namaz Vakitleri"
        : t('prayer_times_title_regular'); // "Namaz Vakitleri"
  }
